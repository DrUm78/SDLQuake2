...
//PGM
					...
					else if (coloredlights)
					{
						...
						//qb: works now...
						trans[0] = CLAMP((int)(pix24[0] * (pspanpackage->lightr * shadelight[0])) >> 16, 0, 31);
						trans[1] = CLAMP((int)(pix24[1] * (pspanpackage->lightg * shadelight[1])) >> 16, 0, 31);
						trans[2] = CLAMP((int)(pix24[2] * (pspanpackage->lightb * shadelight[2])) >> 16, 0, 31);
