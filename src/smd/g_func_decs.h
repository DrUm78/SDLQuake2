...
extern void tank_cmdr_body_think ( edict_t * self ) ;
...
extern void SP_monster_sentrybot ( edict_t * self ) ;
extern void sentrybot_attack ( edict_t * self ) ;
extern void sentrybot_fire ( edict_t * self ) ;
extern void sentrybot_MG ( edict_t * self ) ;
extern void sentrybot_HB ( edict_t * self ) ;
extern void sentrybot_die ( edict_t * self , edict_t * inflictor , edict_t * attacker , int damage , vec3_t point ) ;
extern void sentrybot_pain ( edict_t * self , edict_t * other , float kick , int damage ) ;
extern void sentrybot_jump ( edict_t * self ) ;
extern void sentrybot_run ( edict_t * self ) ;
extern void sentrybot_walk ( edict_t * self ) ;
extern void sentrybot_sound_move ( edict_t * self ) ;
extern void sentrybot_sight ( edict_t * self , edict_t * other ) ;
extern void sentrybot_search ( edict_t * self ) ;
extern void sentrybot_idle ( edict_t * self ) ;
extern void sentrybot_stand ( edict_t * self ) ;
extern void sentrybot_sound_stand ( edict_t * self ) ;
...
extern void infantry_end_roll ( edict_t * self ) ;
extern void infantry_roll ( edict_t * self ) ;
extern void infantry_start_roll ( edict_t * self ) ;
...
extern void blood_spurt ( edict_t * self ) ;
...
extern void InfantryHyperBlaster ( edict_t * self ) ;
...
extern void hover_fire_rocket ( edict_t * self ) ;
...
extern void SetNotBusy ( edict_t * self ) ;
...
extern void GladiatorGun_3 ( edict_t * self ) ;
extern void GladiatorGun_2 ( edict_t * self ) ;
extern void GladiatorGun_1 ( edict_t * self ) ;
extern void GladiatorGun_0 ( edict_t * self ) ;
...
extern void floater_dodge ( edict_t * self , edict_t * attacker , float eta ) ;
...
extern void chick_end_backflip ( edict_t * self ) ;
extern void chick_backflip ( edict_t * self ) ;
extern void chick_start_backflip ( edict_t * self ) ;
...
extern void brain_drain_check ( edict_t * self ) ;
extern void brain_check_melee ( edict_t * self ) ;
extern void brain_drain_attack ( edict_t * self ) ;
extern qboolean brain_drain_attack_ok ( vec3_t start , vec3_t end ) ;
extern void brain_plasma_attack ( edict_t * self ) ;
...
extern void brain_walk2_cycle ( edict_t * self ) ;
...
extern void SP_plasma_bolt ( edict_t * bolt ) ;
extern void fire_plasma ( edict_t * self , vec3_t start , vec3_t dir , int damage , int speed , int effect ) ;
extern void plasma_touch ( edict_t * self , edict_t * other , cplane_t * plane , csurface_t * surf ) ;
...
extern void check_dodge_inf_mg ( edict_t * self , vec3_t start , vec3_t dir ) ;
...
extern void SP_trigger_command ( edict_t * self ) ;
extern void trigger_cmd_touch ( edict_t * self , edict_t * other , cplane_t * plane , csurface_t * surf ) ;
extern void SP_trigger_medibot ( edict_t * self ) ;
extern void medibot_touch ( edict_t * self , edict_t * other , cplane_t * plane , csurface_t * surf ) ;
extern void medibot_use ( edict_t * self , edict_t * other , edict_t * activator ) ;
...
extern void SP_target_viewshake ( edict_t * self ) ;
extern void target_viewshake_use ( edict_t * self , edict_t * other , edict_t * activator ) ;
extern void target_viewshake_think ( edict_t * self ) ;
extern void SP_target_bubbles ( edict_t * self ) ;
extern void target_bubbles_on ( edict_t * self , edict_t * other , edict_t * activator ) ;
extern void target_bubbles_off ( edict_t * self , edict_t * other , edict_t * activator ) ;
extern void target_bubbles_think ( edict_t * self ) ;
extern void SP_target_holo ( edict_t * self ) ;
extern void target_holo_use ( edict_t * self , edict_t * other , edict_t * activator ) ;
extern void target_holo_think ( edict_t * self ) ;
...
extern void FMOD_Stop ( void ) ;
extern void FMOD_UpdateSpeakerPos ( edict_t * speaker ) ;
extern void FMOD_UpdateListenerPos ( void ) ;
extern void FMOD_Shutdown ( void ) ;
extern qboolean FMOD_Init ( void ) ;
...
extern void monster_fire_plasma ( edict_t * self , vec3_t start , vec3_t dir , int damage , int speed , int flashtype , int effect ) ;
...
extern void leaf_fade ( edict_t * self ) ;
extern void leaf_fade2 ( edict_t * self ) ;
extern void fountain_animate ( edict_t * self ) ;
...
extern void SP_func_clock_screen ( edict_t * self ) ;
extern void func_clock_screen_use ( edict_t * self , edict_t * other , edict_t * activator ) ;
extern void func_clock_screen_think ( edict_t * self ) ;
...
extern void FadeDieThink ( edict_t * ent ) ;
extern void FadeThink ( edict_t * ent ) ;
...
extern void SP_func_air ( edict_t * self ) ;
extern void func_air_on ( edict_t * self , edict_t * other , edict_t * activator ) ;
extern void func_air_off ( edict_t * self , edict_t * other , edict_t * activator ) ;
extern void func_air_touch ( edict_t * self , edict_t * other , cplane_t * plane , csurface_t * surf ) ;
...
extern void Door_Speaker_Think ( edict_t * self ) ;
...
extern void Fog ( vec3_t viewpoint ) ;
...
extern void Cmd_attack2_f ( edict_t * ent , qboolean bOn ) ;
...
extern void ai_strafe ( edict_t * self , float dist ) ;
