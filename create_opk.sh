...
/opt/gcw0-toolchain/usr/bin/mipsel-gcw0-linux-uclibc-strip releasegcw/*.so releasegcw/baseq2/*.so releasegcw/sdlquake2 releasegcw/rogue/*.so releasegcw/xatrix/*.so
